...
<body style="backgorund: #f0f0f0;">
    ...
    <nav class="navbar navbar-inverse" style=" border-raduis: 0px;">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    aria-expanded="false"><i class="glyphicon glyphicon-wrench"></i>Pengaturan<span class="caret"></i></span><a>
                    <ul class="dropdown-menu"><li><a gref="harga.php"><i  class="glyphicon glyphicon-used"></i>
                    Pengaturan harga</a></li><li><a href="ganti_password.php"><i class="glyphicon glyphicon-icon"></i>
                    Ganti Password</a></li>
                </ul>
            </li>
